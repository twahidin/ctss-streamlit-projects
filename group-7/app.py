...
AmountCustomerActual=int(st.number_input('amound of customer',step=1,min_value=1))
PutStuffs(AmountCustomerActual)
...
# Display selected seats details
if AmountCustomerActual>st.session_state.selected_seats:
  st.write("select more")
elif AmountCustomerActual<st.session_state.selected_seats:
  st.write("select less")
